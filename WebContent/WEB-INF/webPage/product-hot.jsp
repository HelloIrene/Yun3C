   	...
   	<c:forEach items="${requestScope.plist }" var="p" varStatus="st">
		<div class="grid_1_of_4 images_1_of_3">
			<a href="product.html?id=${p.productID}"><img src="${p.imgPath}" alt="pic" style="height:200px;"></a>
           	<h2>${p.productName} <b>${p.price}</b>元秒杀价！ </h2>
	...
	<div class="section group">
        	...
        	<div class="content-pagenation">
				...
				<c:when test="${requestScope.page == 1 }">
					...
					<li><a href="product-hot.html?page=${requestScope.page+1 }">下一页</a></li>
					<li><a href="product-hot.html?page=${requestScope.totalPage }">最后页</a></li>
				</c:when>
				<c:when test="${requestScope.page == requestScope.totalPage }">
					<li><a href="product-hot.html?page=1">第一页</a></li> 
					<li><a href="product-hot.html?page=${requestScope.page-1 }">上一页</a></li>
				...
				<div class="rightsidebar span_3_of_1">
					...
					<ul>
				      ...
				      <li><a href="productType.html?wd=电脑、手机配件">电脑、手机配件</a></li>
