...
<div class="container">
    <div class="public-content">
        <div class="public-content-header">
            <h3 style="display: inline-block;">推荐商品列表</h3>
		...
		<table class="public-cont-table col-2" style="width: 100%;">
			...
			<c:forEach items="${requestScope.recommends}" var="product">
				<tr style="height: 49px; width: 986px;">
					...
					<td>${product.sales}</td>
					<td>${product.stock}</td>
					<td><a href="deleterecommend?id=${product.productID}"><button class="btn btn-primary" style="color:white;height: 30px;width: 90px;">下架推荐</button></a></td>
				</tr>
			</c:forEach>
		</table>
        <div class="public-content-header">
            <h3 style="display: inline-block;">未推荐商品列表</h3>
            <div class="public-content-right fr">
            </div>
        </div>
        <div class="clearfix"></div>
		<table class="public-cont-table col-2" style="width: 100%;">
			...
			<c:forEach items="${requestScope.norecommends}" var="product">
				<tr style="height: 49px; width: 986px;">
					...
					<td>${product.sales}</td>
					<td>${product.stock}</td>
					<td><a href="updaterecommend?id=${product.productID}"><button class="btn btn-primary" style="color:white;height: 30px;width: 90px;">上架推荐</button></a></td>
				</tr>
			</c:forEach>
		</table>
	</div>
